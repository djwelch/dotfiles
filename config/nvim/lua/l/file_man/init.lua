...
function layer.init_config()
  ...
  keybind.bind_command(edit_mode.NORMAL, "<leader>pf", ":CtrlP<CR>", { noremap = true }, "Find file")
  keybind.bind_command(edit_mode.NORMAL, "<leader>bb", ":CtrlPBuffer<CR>", { noremap = true }, "Find buffer")
  keybind.bind_command(edit_mode.NORMAL, "<leader>fr", ":CtrlPMRU<CR>", { noremap = true }, "Recent files")
